...
#SBATCH --job-name=mpa-Mistral-7b-v0.2-hf-no-sys-sft-66k-orpo    # Job name
...
# echo "Starting job"
srun accelerate launch --main_process_port 29501 -m axolotl.cli.train /mnt/nas/suehyun/axolotl/examples/mpa/no-system/mistral-7b-66k-orpo.yml