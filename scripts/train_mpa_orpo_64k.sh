...
#SBATCH --job-name=mpa_mistral-7b-66k-orpo        # Job name
...
srun accelerate launch -m axolotl.cli.train /mnt/nas/suehyun/axolotl/examples/mpa/mistral-7b-66k-orpo.yml